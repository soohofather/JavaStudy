...
public class PdfFile {
    ...
    public void createPdf(String dest) throws MalformedURLException, IOException {
        ...
        try {
            headerFont = PdfFontFactory.createFont("NanumGothic.ttf", PdfEncodings.IDENTITY_H, PdfFontFactory.EmbeddingStrategy.PREFER_EMBEDDED);
            bodyFont = PdfFontFactory.createFont("NanumGothic.ttf", PdfEncodings.IDENTITY_H, PdfFontFactory.EmbeddingStrategy.PREFER_EMBEDDED);
        }catch (IOException e) {
            e.printStackTrace();
        }
